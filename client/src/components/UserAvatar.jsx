...
const UserAvatar = () => {
  ...
  as="button"
  onClick={() => setOpen(true)}
  className="text-gray-700 dark:text-gray-300 group flex w-full items-center rounded-md px-2 py-2 text-base data-[active]:bg-gray-100 dark:data-[active]:bg-gray-700"
>
  <FaUser className="mr-2" aria-hidden="true" />
  Profile
</MenuItem>
...
<MenuItem
  ...
  className="text-red-600 group flex w-full items-center rounded-md px-2 py-2 text-base data-[active]:bg-red-100 dark:data-[active]:bg-red-800"
>
